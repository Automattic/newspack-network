...
class Story_Budget {
	...
	public static function add_fields( $fields ) {
		if ( ! class_exists( '\Newspack_Network\Content_Distribution' ) ) {
			return $fields;
		}
	...
	/**
	 * Add story metadata to the Newspack Story Budget.
	 *
	 ...
	 */
	public static function add_story_metadata( $metadata, $story_id ) {
